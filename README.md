...
<h3>開発背景</h3>
機械学習では、前処理として必要なデータの摘出作業や単語整形をする必要がある。<br>
<ul>
  <li>特定のデータ行のみ摘出する</li>
  <li>特定のデータ列のみ摘出する</li>
  <li>数字や記号など、意味関数が低い単語を0などの単語に統一する</li>
</ul>
上記の要件を満たす前処理プログラムを、目的に応じて作成し直すのが面倒だったため、予め必要な機能をアプリにして実装することにした。<br><br>
...
「10%」~「90%」を選択した場合は正解ラベルを出力します。<br><br>
